            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left" novalidate>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control col-md-7 col-xs-12" name="ten_app" type="text" value="{{$data['app-edit']['ten_app']}}">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control col-md-7 col-xs-12" name="website" required="required" type="text" value="{{$data['app-edit']['website']}}">
                        </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            <a class="btn btn-primary" href="{{Route('App')}}" name="cancel">Cancel</a>
